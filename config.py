...
LOG_GROUP = int(os.getenv("LOG_GROUP", "-1002678697154")) # optional with -100
FORCE_SUB = int(os.getenv("FORCE_SUB", "-1002553439091")) # optional with -100
...
JOIN_LINK = os.getenv("JOIN_LINK", "https://t.me/wabxbots") # this link for start command message
